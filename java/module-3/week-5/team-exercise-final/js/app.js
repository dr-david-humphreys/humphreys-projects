...
/*
 * Create generateProblemSet() function that generates a problem set with {PROBLEMS_PER_SET} problems
 *
 */
...
/**
 * Create displayProblemSet() function to handle displaying the current problem set
 * The expression & answers are both empty by default
 * Call displayProblem() and displayAnswers()
 */
...
/**
 * Create displayProblem() function to set the current problem (expression) based on the currentProblem
 *
 */
...
/**
 * Create displayAnswers() function to display the 4 possible answers for the current problem
 */
...
/**
 * Create a nextProblem() function to move to the next problem in the set
...
/**
 * Create updateCurrentProblem() function to increment the current problem by 1 and sets the display of the new problem expression
 */
...
/**
 * Create updateScore() function to increment the score by 1 and updates the current score
 */
...
/**
 * Create clearScore() function to clear the score back to 0
 */
 function clearScore() {
...
/**
 * Create toggleShowHide() function
...
/**
 * Create a getRandomNumber(max) utility function to generate a random number based on max
 * @param {number} max
 */
...
/** 
 * Create a shuffleArray(arr) utility function to shuffle the items in an array
 * @param {object} arr
 */
...
/**
 * Create a startNewProblemSet() function that starts a new application by
 ...
 * Make sure the below code runs after the DOM has been loaded
 */
