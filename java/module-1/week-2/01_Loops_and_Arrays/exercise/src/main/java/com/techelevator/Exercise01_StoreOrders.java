...
public class Exercise01_StoreOrders {
    ...
    public int getCheesePizzaRevenue(int[] orders) {
        int smallCheeseCount = 0;
        int mediumCheeseCount = 0;
        int largeCheeseCount = 0;
        ...
        totalCheeseRevenue = (smallCheeseCount * 8) + (mediumCheeseCount * 11) + (largeCheeseCount * 14);
        return totalCheeseRevenue;
    }
}
